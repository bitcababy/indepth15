...
#   unless typeof value is "undefined" # name and value given, set cookie
#     options = options or {}
#     if value is null
#       value = ""
#       options.expires = -1
#     expires = ""
#     if options.expires and (typeof options.expires is "number" or options.expires.toUTCString)
#       date = undefined
