...
module ApplicationHelper
  ...
  def duration_string(duration)
    return {Durations::FULL_YEAR => 'Full Year', Durations::FIRST_SEMESTER => 'First Semester', Durations::SECOND_SEMESTER => 'Second Semester', Durations::FULL_YEAR_HALF_TIME => 'Full Year, half time'}[duration]
  end
