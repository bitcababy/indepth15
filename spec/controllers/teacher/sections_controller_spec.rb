...
describe Teacher::SectionsController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created section" do
        post :create, {:section => valid_attributes}
        response.should redirect_to(teacher_section_url(Section.last))
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested section" do
        section = Section.create! valid_attributes
        # Assuming there are no other teacher_sections in the database, this
        # specifies that the Section created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Section.any_instance.expects(:update_attributes).with({'these' => 'params'})
        put :update, {:id => section.to_param, :section => {'these' => 'params'}}
      end
      ...
      it "redirects to the section" do
        section = Section.create! valid_attributes
        put :update, {:id => section.to_param, :section => valid_attributes}
        response.should redirect_to(teacher_section_url(section))
      end
    end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the teacher_sections list" do
      section = Section.create! valid_attributes
      delete :destroy, {:id => section.to_param}
      response.should redirect_to(teacher_sections_url)
    end
  end
