...
describe Teacher::AssignmentsController do
  ...
  # Teacher::Assignment. As you add validations to Teacher::Assignment, be sure to
  ...
  # Teacher::AssignmentsController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all teacher_assignments as @assignments" do
			pending "Unfinished test"
      assignment = Assignment.create! valid_attributes
      get :index, {}, valid_session
      assigns(:teacher_assignments).should eq([assignment])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created assignment" do
        post :create, {:assignment => valid_attributes}, valid_session
        response.should redirect_to(teacher_assignment_url(Assignment.last))
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested assignment" do
        assignment = Assignment.create! valid_attributes
        # Assuming there are no other teacher_assignments in the database, this
      ...
      it "redirects to the assignment" do
        assignment = Assignment.create! valid_attributes
        put :update, {:id => assignment.to_param, :assignment => valid_attributes}, valid_session
        response.should redirect_to(teacher_assignment_url(assignment))
      end
    end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the teacher_assignments list" do
      assignment = Assignment.create! valid_attributes
      delete :destroy, {:id => assignment.to_param}, valid_session
      response.should redirect_to(teacher_assignments_url)
    end
  end
